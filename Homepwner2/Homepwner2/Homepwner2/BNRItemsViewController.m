...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    NSLog(@"BNRITEMSVIEWCONTROLLER viewDidLoad");
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //cell.valueLabel.text = [NSString stringWithFormat:@"$%d", item.valueInDollar];
    cell.valueLabel.text = [currencyFormatter stringFromNumber:@(item.valueInDollar)];
