...
- (void)encodeRestorableStateWithCoder:(NSCoder *)coder
{
    ...
    self.item.valueInDollar = [self.valueField.text intValue];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.valueField.text = [NSString stringWithFormat:@"%d", item.valueInDollar];
    ...
    self.assetTypeButton.title = [NSString stringWithFormat:NSLocalizedString(@"Type: %@", @"Asset type button")];
...
- (void)viewWillDisappear:(BOOL)animated
{
    ...
    //item.valueInDollar = [self.valueField.text intValue];
    
    int newValue = [self.valueField.text intValue];
    
    //Is this changed?
    if (newValue != item.valueInDollar) {
        //Puth it in the item
        item.valueInDollar = newValue;
